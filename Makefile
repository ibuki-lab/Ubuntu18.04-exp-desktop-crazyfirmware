...
PROJ_OBJ += position_estimator_altitude.o position_controller_pid.o position_controller_indi.o position_controller_Clover.o
PROJ_OBJ += estimator.o estimator_complementary.o
PROJ_OBJ += controller.o controller_pid.o controller_mellinger.o controller_indi.o controller_rpyt.o controller_thrust.o controller_attitude_Clover.o controller_pid_Clover.o
