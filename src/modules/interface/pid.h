...
#define PID_ROLL_RATE_KP  50.0 //250.0
#define PID_ROLL_RATE_KI  50.0  //500.0
#define PID_ROLL_RATE_KD  0.0 //2.5
#define PID_ROLL_RATE_INTEGRATION_LIMIT    33.3

#define PID_PITCH_RATE_KP  50.0 //250.0
#define PID_PITCH_RATE_KI  50.0  //500.0
#define PID_PITCH_RATE_KD  0.0  //2.5
#define PID_PITCH_RATE_INTEGRATION_LIMIT   33.3

#define PID_YAW_RATE_KP  30.0 //120.0
#define PID_YAW_RATE_KI  3.0  //16.7
#define PID_YAW_RATE_KD  0.0  //0.0
#define PID_YAW_RATE_INTEGRATION_LIMIT     166.7

#define PID_ROLL_KP  10.0 //6.0
#define PID_ROLL_KI  5.0 //3.0
#define PID_ROLL_KD  0.0 //0.0
#define PID_ROLL_INTEGRATION_LIMIT    20.0

#define PID_PITCH_KP  10.0 //6.0
#define PID_PITCH_KI  5.0  //3.0
#define PID_PITCH_KD  0.0  //0.0
#define PID_PITCH_INTEGRATION_LIMIT   20.0

#define PID_YAW_KP  5.0     //6.0
#define PID_YAW_KI  3.0     //1.0
